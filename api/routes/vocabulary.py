...
def enhance_word(
    ...
    # Example sentence is now generated by the LLM in enhance_word()
    example_original = result.get("example_sentence")
    example_translation = result.get("example_sentence_translation")

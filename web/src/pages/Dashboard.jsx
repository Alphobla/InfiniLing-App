    ...
    <div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        ...
        <div className="flex flex-wrap gap-3">
          <Link to="/vocabulary" className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">
            Browse Vocabulary
          </Link>
          <Link to="/story" className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">
            Generate Story
          </Link>
        </div>
      </div>
